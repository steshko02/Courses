...
import com.example.coursach.service.model.mail.CourseNotification;
...
@Component
@Getter
public class CourseTemplate implements MailTemplate {

    private final TemplateUtils templateUtils;

    private final MailProperties mailProperties;

    private final MailScope mailScope = MailScope.COURSE_START;
    ...
    public CourseTemplate(TemplateUtils templateUtils, MailProperties mailProperties) {
    ...
    public SimpleMailMessage construct(Notification notification) {
        final CourseNotification lessonNotification = (CourseNotification) notification;
    ...
    private SimpleMailMessage buildSimpleMailMessage() {
        ...
        simpleMailMessage.setSubject(String.format(Patterns.COURSES_NAMING_PATTERN, "COURSE NOTIFICATION"));
